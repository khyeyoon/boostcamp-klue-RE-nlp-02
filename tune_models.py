...
class TunedModelLSTM(nn.Module):
    def __init__(self, base_model, num_classes, device, n_layer = 1, lstm_dim = 768):
        super().__init__()
        self.base_model= base_model
        ...
        self.rnn = nn.LSTM(input_size = 768, hidden_size = self.lstm_dim, num_layers = self.n_layer, batch_first = True)
